...
def upgrade() -> None:
    ...
    sa.Column('language', sa.Enum('ru', 'en', 'de', name='language_code', native_enum=False, length=8), nullable=True),
    sa.Column('selected_city', sa.Enum('berlin', 'delivery', name='city_choice', native_enum=False, length=32), nullable=True),
    ...
    sa.Column('status', sa.Enum('New', 'Accepted', 'Completed', 'Cancelled', name='order_status', native_enum=False, length=32), server_default='New', nullable=False),
    sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=False),
